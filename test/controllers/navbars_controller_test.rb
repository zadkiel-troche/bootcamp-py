...
class NavbarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create navbar" do
    assert_difference("Navbar.count") do
      post navbars_url, params: { navbar: { id: @navbar.id, label: @navbar.label, url: @navbar.url } }
    end
  ...
  test "should update navbar" do
    patch navbar_url(@navbar), params: { navbar: { id: @navbar.id, label: @navbar.label, url: @navbar.url } }
